...
GLOBAL_LIST_INIT(runed_metal_recipes, list ( \
	new /datum/stack_recipe("runed door (a weak door that stuns non-cultists who touch it))", /obj/machinery/door/airlock/bloodcult, 1, time = 5 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	...
	new /datum/stack_recipe("pylon (heals (and regenerates the blood of) nearby blood cultists and constructs, but also turns nearby floor tiles into engraved flooring)", /obj/structure/destructible/bloodcult/pylon, 4, time = 4 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	new /datum/stack_recipe("daemon forge (can make Nar'Sien hardened armor, flagellant's robes, and eldritch longswords)", /obj/structure/destructible/bloodcult/forge, 3, time = 4 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	new /datum/stack_recipe("archives (can make zealot's blindfolds, shuttle curse orbs, and veil walker equipment)", /obj/structure/destructible/bloodcult/tome, 3, time = 4 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	new /datum/stack_recipe("altar (can make eldritch whetstones, construct shells, and flasks of unholy water)", /obj/structure/destructible/bloodcult/talisman, 3, time = 4 SECONDS, one_per_turf = TRUE, on_floor = TRUE), \
	))
...
GLOBAL_LIST_INIT(bronze_recipes, list ( \
	new/datum/stack_recipe("wall gear", /obj/structure/girder/clockcult, 2, time = 20, one_per_turf = TRUE, on_floor = TRUE), \
	null,
	...
	new/datum/stack_recipe("pinion airlock assembly", /obj/structure/door_assembly/door_assembly_clockcult, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("bronze pinion airlock assembly", /obj/structure/door_assembly/door_assembly_clockcult/seethru, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("bronze floor tile", /obj/item/stack/tile/clockcult, 1, 4, 20), \
...
/obj/item/stack/sheet/bronze
	...
	tableVariant = /obj/structure/table/clockcult
	material_type = /datum/material/bronze
	walltype = /turf/closed/wall/mineral/clockcult
	has_unique_girder = TRUE
