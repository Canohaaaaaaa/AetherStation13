...
#define span_bloodcult(str) ("<span class='bloodcult'>" + str + "</span>")
#define span_bloodcultbold(str) ("<span class='bloodcultbold'>" + str + "</span>")
#define span_bloodcultboldtalic(str) ("<span class='bloodcultboldtalic'>" + str + "</span>")
#define span_bloodcultitalic(str) ("<span class='bloodcultitalic'>" + str + "</span>")
#define span_bloodcultlarge(str) ("<span class='bloodcultlarge'>" + str + "</span>")
#define span_clockcult(str) ("<span class='clockcult'>" + str + "</span>")
#define span_clockcultbold(str) ("<span class='clockcultbold'>" + str + "</span>")
#define span_clockcultboldtalic(str) ("<span class='clockcultboldtalic'>" + str + "</span>")
#define span_clockcultitalic(str) ("<span class='clockcultitalic'>" + str + "</span>")
#define span_clockcultlarge(str) ("<span class='clockcultlarge'>" + str + "</span>")
...
#define span_ratvarsmall(str) ("<span class='ratvarsmall'>" + str + "</span>")
