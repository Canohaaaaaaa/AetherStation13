...
/mob/camera/blob/proc/create_blobbernaut()
	...
	if(LAZYLEN(candidates)) //if we got at least one candidate, they're a blobbernaut now.
		...
		to_chat(blobber, "You are powerful, hard to kill, and slowly regenerate near nodes and cores, [span_bloodcultlarge("but will slowly die if not near the blob")] or if the factory that made you is killed.")
